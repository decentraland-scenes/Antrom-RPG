...
import { DAILY_FREE_TOKENS, DIFFICULTIES, DUNGEONS, DUNGEONS_TO_SHOW,  PREMIUM_TOKENS, SEASON_PASS } from './dungeonsData'
import type {Option, OptionWithArray} from './dungeonsData'


export function setupDungeonSelectionUi(): void {
...
function OptionButton(props: OptionWithArray): ReactEcs.JSX.Element {
  return (
    <UiEntity
...
function selectOption(id: string, array: Option[]): void {
...
let timer: number = 2
export function loadingDungeonSystem(dt: number): void {
...
function openDungeonSelection(): void {
