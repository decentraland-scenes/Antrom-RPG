...
export class Antrom {
  ...
  createTriggerZoneForBerserkerUpgradeMarket() {
  ...
  createTriggerZoneForResourceMarket() {
  ...
  createTriggerZoneForRangerUpgradeMarket() {
  ...
  createTriggerZoneForMageUpgradeMarket() {
  ...
  createTriggerZoneForApprenticeMarket() {
  ...
  createTriggerZoneForSkillChange() {
  ...
  createTriggerZoneForMagicalItemsMarketHUD() {
  ...
  createTriggerZoneFoDailyRewards() {
