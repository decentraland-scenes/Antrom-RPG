  ...
  createDungeon(difficulty: Difficulty, location: Location):void {
    ...
    if (location.CAVE) {
      ...
      if (difficulty.EASY) {
        ...
        this.createCaveDungeonEnemies(easyEnemyAttack, easyEnemyHP)
      ...
      // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        ...
        this.createCaveDungeonEnemies(mediumEnemyAttack, mediumEnemyHP)
        // const wastelandApex = Array.from(
        //     { length: 1 },
    ...
    // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
      ...
      if (difficulty.EASY) {
        ...
        this.createDesertDungeonEnemies(easyEnemyAttack, easyEnemyHP)
        // const wastelandApex = Array.from(
        //     { length: 1 },
      ...
      // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        ...
        this.createDesertDungeonEnemies(mediumEnemyAttack, mediumEnemyHP)
        // const wastelandApex = Array.from(
        //     { length: 1 },
      ...
      // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        ...
        const hardEnemyAttack = 900
        const hardEnemyHP = 9000
        this.createCaveDungeonEnemies(hardEnemyAttack, hardEnemyHP)
        // const wastelandApex = Array.from(
        //     { length: 1 },
        //     () => new HardCaveDungeonBoss(hardEnemyAttack)
        // )
      ...
      // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        ...
        const nightmareEnemyAttack = 2000
        const nightmareEnemyHP = 222500
          this.createCaveDungeonEnemies(nightmareEnemyAttack, nightmareEnemyHP)
        //   const wastelandApex = Array.from(
        //     { length: 1 },
        //     () => new NightmareCaveDungeonBoss(nightmareEnemyAttack)
        // )
