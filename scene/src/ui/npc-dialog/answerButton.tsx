...
import { type DialogButton, npcDialogsSprites, BUTTON_HEIGHT_FACTOR, BUTTON_WIDTH_FACTOR } from "./dialogsData"
...
export function AnswerButton({ answer, goToDialog }: AnswerButtonType): ReactEcs.JSX.Element {
    ...
    return (
      ...
      >
        <Button
          ...
          onMouseDown={()=>{goToDialog(answer.goToDialog)}}
        />
        <UiEntity
          uiTransform={{
