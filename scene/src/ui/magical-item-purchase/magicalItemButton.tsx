...
import { type MagicalItem, magicalItemsMarketSprites } from "./magicalItemPurchaseData"
...
export function MagicalItemButton({
    magicalItem, selectedMagicalItem, selectMagicalItem
