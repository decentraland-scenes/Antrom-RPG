...
import { Entity, AudioSource, Animator, GltfContainer, Transform, MeshRenderer, engine, VisibilityComponent, pointerEventsSystem, InputAction } from "@dcl/sdk/ecs";
...
export default class Chicken extends MonsterMeat {
    ...
    loadTransformation(): void {
        let initialPosition =  Vector3.create(getRandomIntRange(1, 31), 0, getRandomIntRange(0, 24))
